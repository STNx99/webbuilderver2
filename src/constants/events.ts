...
export type NavigateTarget = (typeof NAVIGATE_TARGETS)[keyof typeof NAVIGATE_TARGETS];
...
export type ScrollBehavior = (typeof SCROLL_BEHAVIORS)[keyof typeof SCROLL_BEHAVIORS];
...
export type DataValueType = (typeof DATA_VALUE_TYPES)[keyof typeof DATA_VALUE_TYPES];
...
export type EventValueSource = (typeof EVENT_VALUE_SOURCES)[keyof typeof EVENT_VALUE_SOURCES];
 ...
 */
export function getEventTypeValues(): EventType[] {
 ...
 */
export function getActionTypeValues(): ActionType[] {
 ...
 */
export function getConditionOperatorValues(): ConditionOperator[] {
...
export function isValidActionType(value: unknown): value is ActionType {
  return Object.values(ACTION_TYPES).includes(value as ActionType);
}
 ...
 */
export function isValidConditionOperator(value: unknown): value is ConditionOperator {
  return Object.values(CONDITION_OPERATORS).includes(value as ConditionOperator);
}
