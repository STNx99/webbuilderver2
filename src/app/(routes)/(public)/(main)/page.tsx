                ...
                <div className="container mx-auto px-4 lg:px-6 text-center relative">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            Join thousands of creators who trust Canvas to bring
                            their vision to life. Clean, fast, and beautifully
                            animated—just the way it should be.
                        </p>
                        <div
                ...
                <div className="container mx-auto px-4 lg:px-6">
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            <p className="text-muted-foreground leading-relaxed max-w-sm">
                                The easiest way to build professional websites
                                with one-message theme switching and smooth
                                animations.
                            </p>
                        </div>
                    ...
                    >
                        <p className="text-muted-foreground">
                            © {new Date().getFullYear()} Canvas. All rights
                            reserved.
                        </p>
