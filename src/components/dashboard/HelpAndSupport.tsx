        ...
        <section className="relative w-full overflow-hidden px-4 py-24 sm:px-8">
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-8">
                ...
                >
                    ...
                    <p className="max-w-2xl pt-2 text-lg 
                    text-muted-foreground">
                        Chúng tôi luôn sẵn sàng hỗ trợ bạn. Tìm câu trả lời nhanh chóng cho câu hỏi của bạn
                        hoặc liên hệ trực tiếp với đội ngũ hỗ trợ chuyên nghiệp của chúng tôi.
                    </p>
                </motion.div>
                ...
                >
                    <Tabs defaultValue="faq" className="w-full">
                        <TabsList className="mx-auto grid w-full max-w-md grid-cols-3 bg-muted/30">
                            ...
                            <TabsTrigger value="contact" className="rounded-full data-[state=active]:bg-background data-[state=active]:shadow-sm">Liên hệ</TabsTrigger>
                            <TabsTrigger value="guides" className="rounded-full data-[state=active]:bg-background data-[state=active]:shadow-sm">Hướng dẫn</TabsTrigger>
                        </TabsList>
                                ...
                                <Card className="w-full max-w-4xl mx-auto">
                                    <CardContent className="py-12 text-center">
                                        ...
                                        <p className="text-muted-foreground">
                                            Không tìm thấy câu hỏi phù hợp. Thử tìm kiếm từ khóa khác hoặc liên hệ hỗ trợ.
                                        </p>
                                    </CardContent>
                                </Card>
                            ) : (
                                        ...
                                        >
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col items-center text-center">
                                                    ...
                                                    <p className="mb-2 font-medium text-primary">{channel.contact}</p>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="pt-4 bg-primary/5 rounded-lg p-4 mt-4">
                                                <p className="text-sm text-center">
                                                    <strong className="text-primary">Lưu ý:</strong> Live Chat hoạt động 24/7.
                                                    Email được trả lời trong vòng 24 giờ làm việc. Hotline chỉ hoạt động trong giờ hành chính.
                                                </p>
                                            </div>
                                        </div>
                                    </CardContent>
                                    ...
                                    <CardContent>
                                        <form className="space-y-4">
                                            <div className="grid gap-4 md:grid-cols-2">
                                                <Input placeholder="Họ và tên" className="bg-background" />
                                    ...
                                    <CardContent>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <h4 className="mb-1 font-semibold">Diễn đàn cộng đồng</h4>
                                                    <p className="text-sm text-muted-foreground">
