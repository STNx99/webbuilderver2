            ...
            >
                <Card className="relative overflow-hidden bg-secondary/20 hover:shadow-lg hover:border-primary/30 transition-all duration-300 h-full flex flex-col">
                    ...
                    <CardHeader className="px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <CardTitle className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold">Notification Overview</CardTitle>
                            <CardDescription className="text-xs sm:text-sm md:text-base">Your notification summary for this week</CardDescription>
                        </motion.div>
                    </CardHeader>
                                    ...
                                    >
                                        <div className="flex flex-col gap-3">
                                            <div className="flex items-center justify-between">
                                                <div className={`flex items-center justify-center h-10 w-10 sm:h-12 sm:w-12 rounded-full ${stat.iconBg}`}>
