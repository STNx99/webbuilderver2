...
import { useNotifications, useUpdateNotification } from "@/hooks/features/useNotifications"
import type { Notification, NotificationFilters, NotificationType } from "@/interfaces/notification.interface"
...
export function NotificationList({ filter, search }: NotificationListProps) {
    ...
    const handleMarkAsRead = (notificationId: string, currentReadStatus: boolean) => {
