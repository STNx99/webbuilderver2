  ...
  return (
    <div className="lg:sticky lg:top-8 space-y-6">
      <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
        <Card className="p-6 bg-card/50 backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="relative">
              ...
              <div className="mb-6 p-4 bg-secondary/50 rounded-lg border border-border/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground capitalize">{paymentMethod.replace("-", " ")}</p>
                  </div>
                </div>
              </div>
            )}
                ...
                {!couponApplied ? (
                  ...
                  >
                    ...
                    <Button
                      ...
                      disabled={!couponCode}
                      className="hover:bg-primary/5 hover:text-primary hover:border-primary/50 bg-transparent"
                    >
                      Apply
                    </Button>
                  </motion.div>
            ...
            {onComplete && (
              <Button
                ...
                className={cn(
                  "w-full mt-6 font-semibold transition-all duration-300",
            ...
            <div className="mt-6 p-4 bg-secondary/50 rounded-lg border border-border/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium mb-1">Secure checkout - SSL encrypted</p>
      ...
      >
        <Card className="p-4 bg-primary/5 border-primary/20 backdrop-blur-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium mb-1">14-day money back guarantee</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
