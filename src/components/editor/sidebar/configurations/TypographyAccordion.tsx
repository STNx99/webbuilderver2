      ...
      <AccordionContent>
        ...
        >
          ...
          <AccordionItem value="letter-spacing">
            <AccordionTrigger className="text-xs">Letter Spacing</AccordionTrigger>
            <AccordionContent>
              <div className="flex items-center gap-5 py-1">
          ...
          <AccordionItem value="text-transform">
            <AccordionTrigger className="text-xs">Text Transform</AccordionTrigger>
            <AccordionContent>
              <div className="flex items-center gap-5 py-1">
            ...
            <AccordionContent>
              <div className="flex items-center gap-5 py-1">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateStyle("fontStyle", value === "default" ? undefined : value)}
                >
                  <SelectTrigger className="w-32 max-h-6 px-1 py-0 text-xs border">
          ...
          <AccordionItem value="text-decoration">
            <AccordionTrigger className="text-xs">Text Decoration</AccordionTrigger>
            <AccordionContent>
              <div className="flex items-center gap-5 py-1">
                ...
                <Select
                  value={typeof styles.textDecoration === "string" ? styles.textDecoration : "default"}
                  onValueChange={(value) => updateStyle("textDecoration", value === "default" ? undefined : value)}
                >
                  <SelectTrigger className="w-32 max-h-6 px-1 py-0 text-xs border">
