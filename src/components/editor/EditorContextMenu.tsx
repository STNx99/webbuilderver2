...
export const EditorContextMenu: React.FC<EditorContextMenuProps> = ({
    ...
    return (
        <ContextMenu>
            ...
            <ContextMenuContent className="w-48 z-[100] bg-background border shadow-lg" onContextMenu={(e)=>e.preventDefault()}>
                <ContextMenuItem onClick={onCopy} className="flex justify-between">
                    <div className="flex">
                        <Copy className="mr-2 h-4 w-4" />
                        Copy
                    </div>
                    <span className="text-xs text-muted-foreground w-10 text-left mr-1">⌘C</span>
                </ContextMenuItem>
                <ContextMenuItem onClick={onCut} className="flex justify-between">
                    ...
                    <span className="text-xs text-muted-foreground w-10 text-left mr-1">⌘X</span>
                </ContextMenuItem>
                <ContextMenuItem onClick={onPaste} className="flex justify-between">
                    ...
                    <span className="text-xs text-muted-foreground w-10 text-left mr-1">⌘V</span>
                </ContextMenuItem>
                <ContextMenuSeparator />
                <ContextMenuItem onClick={onBringToFront} className="flex justify-between">
                    <div className="flex">
                        <ArrowUp className="mr-2 h-4 w-4" />
                        Bring to Front
                    </div>
                    <span className="text-xs text-muted-foreground w-10 text-left mr-1">⌘↑</span>
                </ContextMenuItem>
                <ContextMenuItem onClick={onSendToBack} className="flex justify-between">
                    <div className="flex">
