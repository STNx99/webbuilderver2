                    ...
                    <div className="space-y-3">
                        ...
                        <div className="pt-4 bg-primary/5 rounded-lg p-4 mt-4">
                            <p className="text-sm text-center">
                                <strong className="text-primary">Note:</strong> Live Chat operates 24/7.
                                Emails are answered within 24 business hours. Hotline only operates during business hours.
                            </p>
                        </div>
                    </div>
                </CardContent>
