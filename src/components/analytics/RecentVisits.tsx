                                ...
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    >
                                        <Avatar className="h-10 w-10 sm:h-12 sm:w-12 ring-2 ring-transparent group-hover:ring-primary/20 transition-all duration-200">
                                            <AvatarFallback className={`${item.color} text-white font-bold text-sm sm:text-base`}>
                                                {item.avatar}
                                            </AvatarFallback>
                                        </Avatar>
                                    </motion.div>
                                    ...
                                    <div className="flex-1 min-w-0 space-y-2">
                                        <div className="flex items-start justify-between gap-2">
                                            ...
                                            <motion.div
                                                ...
                                                className="flex items-center gap-1 text-green-500 font-medium text-xs sm:text-sm flex-shrink-0"
                                            >
                                        ...
                                        <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0">
                                                    <p className="text-xs sm:text-sm font-bold truncate">{item.views}</p>
                                                    <p className="text-[0.65rem] sm:text-xs text-muted-foreground">views</p>
                                                </div>
                                            </motion.div>
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0">
                                                    <p className="text-xs sm:text-sm font-bold truncate">{item.downloads}</p>
                                                    <p className="text-[0.65rem] sm:text-xs text-muted-foreground">downloads</p>
                                                </div>
                                            </motion.div>
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0">
                                                    <p className="text-xs sm:text-sm font-bold truncate">{item.likes}</p>
                                                    <p className="text-[0.65rem] sm:text-xs text-muted-foreground">likes</p>
                                                </div>
                                            </motion.div>
                                        </div>
                                        ...
                                        <div className="space-y-1">
                                            <div className="flex justify-between text-xs text-muted-foreground">
                                                ...
                                                <span className="font-medium">{((item.downloads / item.views) * 100).toFixed(1)}%</span>
                                            </div>
                                            <div className="h-1.5 bg-secondary rounded-full overflow-hidden">
                                                <motion.div
                                                    initial={{ width: 0 }}
                                                    animate={{ width: `${(item.downloads / item.views) * 100}%` }}
