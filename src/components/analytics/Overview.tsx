                ...
                >
                    <Card className="relative overflow-hidden bg-secondary/20 hover:shadow-lg hover:border-primary/30 transition-all duration-300">
                        ...
                        <CardContent className="px-2 sm:px-4 lg:px-8">
                            ...
                            >
                                <ResponsiveContainer width="100%" height={350} className="sm:h-[350px] md:h-[400px]">
                                            ...
                                            content={({ active, payload }) => {
                                                if (active && payload && payload.length) {
                                                    return (
                                                        ...
                                                        >
                                                            <div className="text-sm font-medium mb-2">{payload[0].payload.date}</div>
                                                            <div className="space-y-1">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className="text-sm font-bold">{payload[2].value}</span>
                                                                </div>
                                                            </div>
                                                        </motion.div>
                                                    )
